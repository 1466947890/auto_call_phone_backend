...
type PhoneStatus int8

const (
	PhoneStatusPending       PhoneStatus = 0
	PhoneStatusCalled        PhoneStatus = 1
	PhoneStatusInterested    PhoneStatus = 2
	PhoneStatusNotInterested PhoneStatus = 3
)
...
type DevicePhone struct {
	...
	Status      PhoneStatus    `gorm:"column:status;type:tinyint(4);not null;default:0" json:"status"`
